...
public class PlayerTest {
	...
	public void testCanGo() {
		...
		assertEquals(false, myPlayer.canGo(-1, 1));
		assertEquals(false, myPlayer.canGo(1, 16));
		assertEquals(false, myPlayer.canGo(1, -1));
		assertEquals(false, myPlayer.canGo(16, 1));
		assertEquals(false, myPlayer.canGo(0, 0));
	...
	public void testCheckHaveWay() {
		...
		assertEquals( false , myPlayer.checkHaveWay( 1 , 5 ) );
		assertEquals( false , myPlayer.checkHaveWay( 5 , 4 ) );
		assertEquals( true , myPlayer.checkHaveWay( 5 , 8 ) );
	}
	...
	public void testGetLevel() {
		myPlayer.setLevel("Easy");
		assertEquals( true ,  myPlayer.getLevel().equals("Easy") );
		
		myPlayer.setLevel("Hard");
		assertEquals( true ,  myPlayer.getLevel().equals("Hard") );
		
		myPlayer.setLevel("Medium");
		assertEquals( true ,  myPlayer.getLevel().equals("Medium") );
	}
	...
	public void testSetLevel() {
		myPlayer.setLevel("Easy");
		assertEquals( myPlayer.getLevel().equals("Easy") , true  );
		
		myPlayer.setLevel("Hard");
		assertEquals( myPlayer.getLevel().equals("Hard") , true  );
		
		myPlayer.setLevel("Medium");
		assertEquals( myPlayer.getLevel().equals("Medium") ,  true );
	}
